    ...
    <div id='home' className='w-full h-screen text-center bg-[#0c1142]'>
      <div className='max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center'>
        <div>
          ...
          <h2 className='py-2 text-white'>Fintech & a Developer </h2>
          <p className='py-4 text-white sm:max-w-[70%] m-auto'>
          MSc Fintech Graduate and dedicated Customer Success Specialist, specializing in enhancing payment solutions through proficient programming and seamless API integrations
          </p>
