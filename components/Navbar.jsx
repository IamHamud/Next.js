    ...
    >
      ...
      >
        <div
          className={
            nav
              ? ' fixed left-0 top-0 w-[75%] sm:w-[60%] md:w-[45%] h-screen bg-#e6e7ec p-10 ease-in duration-500'
        ...
        >
          ...
          <div className='py-4 flex flex-col'>
            <ul className='uppercase text-#1f2937'>
              <Link href='/'>
              ...
              <Link href='/#projects'>
                <li
                onClick={() => setNav(false)} className='py-4 text-sm'>
                Projects
              </li>
            </Link>
            <Link href='/resume'>
